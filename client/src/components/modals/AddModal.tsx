...
const AddModal: FC<IModal> = ({ type, setIsModalVisible }) => {
  return (
    <div
      ...
      tabIndex={-1}
      aria-hidden="true"
      className="flex items-center justify-center fixed top-0 right-0 left-0 z-50 w-full h-full"
    >
        ...
        <div className="relative bg-gray-700 rounded-lg shadow">
          ...
          <div className="flex items-center p-4 md:p-5 border-t border-gray-600 rounded-b">
            ...
            <button
              data-modal-hide={type}
              type="button"
              className="ms-3 text-gray-500 bg-white hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-600 rounded-lg border border-gray-500 text-sm font-medium px-5 py-2.5 hover:text-white focus:z-10"
              onClick={() => setIsModalVisible(false)}
            >
              Decline
            </button>
